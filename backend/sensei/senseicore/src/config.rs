...
impl Default for SenseiConfig {
    fn default() -> Self {
        ...
        Self {
            ...
            bitcoind_rpc_username: String::from("polaruser"),
            bitcoind_rpc_password: String::from("polarpass"),
            network: Network::Bitcoin,
            api_host: String::from("127.0.0.1"),
            api_port: 5401,
            port_range_min: 10000,
            port_range_max: 65535,
            database_url: String::from("postgres://sensei:sensei@postgres:5432/sensei"),
